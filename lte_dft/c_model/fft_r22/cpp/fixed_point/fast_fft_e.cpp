...
#define  TEST_FILE        "F:/project/lte_dft/c_model/fft_r22/data/temp/r4u2_bf1.dat"
FILE  *test_file;

static const unsigned long RX = 4;
static const unsigned long LX = 2;

void fast_fft_e(int *data_real, int *data_imag, int *data_exp, unsigned long ldn, int is)
