...
%SOURCE_FILE  =  '../data/output/dft_sink_fixed12.dat';
%DESTINE_FILE =  '../data/output/dft_sink_float12.dat';
SOURCE_FILE  =  '../data/output/dft_sink_fixed';
DESTINE_FILE =  '../data/output/dft_sink_float';
