...
*/
{
  ...
  if (cutbits >= 0)
  {
    ...
    if(data_imag >= 0)
      ...
      //for debug purpose
	  //int temp1 = (1 << (cutbits-1)) -1;
	  //int temp2 = temp1 + data_imag;
	  //int temp3 = temp2 >> cutbits;
  ...
  //saturation
  data_real = sym_saturation(data_real, MAN_WIDTH);
  data_imag = sym_saturation(data_imag, MAN_WIDTH);
